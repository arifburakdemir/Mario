...
/*    */ 
/*    */   public Curtain(StartMenu startMenu, int gold, int health, int levelCount)
/*    */   {
...
/* 41 */     add(health_label);
/*    */ 
/* 43 */     JLabel level_label = new JLabel("Level - " + levelCount);
...
/* 52 */     add(gold_label);
/*    */ 
/* 56 */     JLabel gold_image = new JLabel("New label");
/*    */ 
/* 58 */     gold_image.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/images/items/gold_4.png")).getImage()
/* 59 */       .getScaledInstance(20, 20, 1)));
/* 60 */     gold_image.setBounds(288, 257, 20, 20);
/* 61 */     add(gold_image);
/*    */   }
/*    */ }
